// https://codepen.io/yowainwright/pen/VKVXRa
//
// TODO: THIS LIBRARY IS TERRIBLE AND BUGGY! FIND A REPLACE OR REWRITE IT.
...
function shave(target, maxHeight, opts) {
  ...
  for (var i = 0; i < els.length; i++) {
    ...
    el.insertAdjacentHTML('beforeend', charHtml);
    var diff = spaces ? words.slice(pivot).join(' ') : words.slice(max);
...
if (typeof window !== 'undefined') {
  ...
  if (plugin) {
    ...
    plugin.fn.unshave = function shavePlugin(maxHeight, opts) {
